          ...
          <div className="col-span-6 flex flex-col justify-center">
            ...
            >
              <p className="text-grey md:text-lg font-normal mb-10 text-start mt-2">
                Join a vibrant community where cooking meets expertise. From
                mastering techniques with top chefs to exploring creative
                recipes, we make cooking fun, easy, and inspiring for everyone.
              </p>
              <p className="text-grey md:text-lg font-normal mb-10 text-start mt-1">
                Whether you're a beginner or a seasoned cook, we're here to
                guide you every step of the way.
              </p>
              {/* <div className="flex align-middle justify-center md:justify-start">
                <button className="text-xl font-medium rounded-full text-white py-3 px-4 bg-pink lg:px-14 mr-6">
                  Learn more
                </button>
              </div> */}
            </Fade>
